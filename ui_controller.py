...
class ParentWindow(QMainWindow):
	...
	def setup_year_window(self):
		...
		depts = ['Architecture', 'Civil Engineering', 'Computer Science & Engineering', 'Electronics & Communications Engineering',\
	...
	def setup_second_window(self):
		...
		self.ui2.nextBtn.clicked.connect(self.generate_event)
