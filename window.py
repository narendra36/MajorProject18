...
class Ui_window(object):
    ...
    def retranslateUi(self, window):
        ...
        self.label_7.setText(_translate("window", "No. of hours per week:"))
        self.lab_checkbox.setText(_translate("window", "Lab"))
        self.label_3.setText(_translate("window", "Semester:"))
        self.label_4.setText(_translate("window", "No. of branches:"))
        self.label_2.setText(_translate("window", "Select whether to add subject or faculty:"))
